...
from model_training import cls_loss,ciou_loss,smooth_l1,Generator,get_img_output_length,class_loss_cls,class_loss_regr
...
if __name__ == "__main__":
    ...
    annotation_path = 'celestial_train.txt'

    model_rpn, model_classifier,model_all = get_model(config,NUM_CLASSES)
    base_net_weights = "celestial_source_weights.h5"
